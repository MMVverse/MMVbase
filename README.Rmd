...
This document summarizes conventions the authors have adopted for naming functions
...
- [Function overview](#function-overview)
  ...
  - [Formulas derived from the Emax parasitemia killing model](#formulas-derived-from-the-emax-parasitemia-killing-model)
